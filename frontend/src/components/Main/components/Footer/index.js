            ...
            <div className="footer">
                ...
                <div className="footer-block2">
                    ...
                    <ul>
                        ...
                        <li><NavLink to={`/${this.linkFormat("Grocery & Gourmet Food")}`}>Grocery & Gourmet
                            Food</NavLink></li>
                        ...
                        <li><NavLink to={`/${this.linkFormat("Arts, Crafts & Sewing")}`}>Arts, Crafts & Sewing</NavLink>
                        </li>
                        <li><NavLink to={`/${this.linkFormat("Kitchen & Dining")}`}>Kitchen & Dining</NavLink></li>
                        <li><NavLink to={`/${this.linkFormat("Home & Kitchen")}`}>Home & Kitchen</NavLink></li>
                        <li><NavLink to={`/${this.linkFormat("Patio, Lawn & Garden")}`}>Patio, Lawn & Garden</NavLink>
                        </li>
                        <li><NavLink to={`/${this.linkFormat("Health & Personal Care")}`}>Health & Personal
                            Care</NavLink></li>
                        <li><NavLink to={`/${this.linkFormat("Cell Phones & Accessories")}`}>Cell Phones &
                            Accessories</NavLink>
                        </li>
                        <li><NavLink to={`/${this.linkFormat("Industrial & Scientific")}`}>Industrial &
