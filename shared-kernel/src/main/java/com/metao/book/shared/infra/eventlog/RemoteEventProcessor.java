...
/**
 * Internal service that regularly retrieve and process
 * {@link StoredDomainEvent}s from all
 * {@link RemoteEventLogService}s that exist in the application context.
 * {@link RemoteEventTranslator}s are used
 * to translate the events into
 * {@link com.metao.book.shared.domain.base.DomainEvent}s, which are then
 * published on
