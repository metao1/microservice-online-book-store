...
public interface RemoteEventLog {
    ...
    /**
     * Returns whether this log is the current log (the one that new events are
     * being appended to).
     */
    boolean isCurrent();
    ...
    /**
     * Checks if this event log contains a {@link StoredDomainEvent} with the given
     * {@link StoredDomainEvent#id() ID}.
     */
