package com.metao.ddd.shared.rest.client;

import com.metao.ddd.shared.infra.eventlog.RemoteEventLog;
import com.metao.ddd.shared.infra.eventlog.RemoteEventLogService;
import com.metao.ddd.shared.infra.eventlog.StoredDomainEvent;
 ...
 * REST-service backed by
 * {@link com.metao.ddd.shared.rest.controller.EventLogController}. Clients
 * should create as many instances of this
...
public class RemoteEventLogServiceClient implements RemoteEventLogService {
     ...
     *
     * @param serverUrl      the base URL of the server. The correct path for the
     *                       event log will be appended automatically.
    ...
    private class RemoteEventLogImpl implements RemoteEventLog {
        ...
        public String toString() {
            return String.format("%s[self=%s, previous=%s, next=%s]", RemoteEventLog.class.getSimpleName(), thisUri,
                    previousLogUri, nextLogUri);
        }
    }
}
