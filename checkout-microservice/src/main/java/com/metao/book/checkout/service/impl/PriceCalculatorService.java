...
// // .stream()
// // .collect(PriceCalculator::new, (k, v) -> k.accept(v.getValue(),
// lookupPrice(v.getKey())), PriceCalculator::combine)
// // .getTotal();
// // }

// // private double lookupPrice(@NonNull final String productKey) {
// // ProductDTO productDetails =
// productCatalogRestClient.getProductDetails(productKey);
...
// // private static final class PriceCalculator implements BiConsumer<Integer,
// Double> {
