...
class ProductServiceTest extends BaseTest {
    ...
    @Test
    void getProductById() {
        ProductNotFoundException productNotFoundException = Assertions.catchThrowableOfType(() -> productService.getProductById(PRODUCT_ID), ProductNotFoundException.class);
        assertSame(ProductNotFoundException.class, productNotFoundException.getClass());
